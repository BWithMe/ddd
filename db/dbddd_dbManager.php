...
function getConnection() {
	...
	global $db_ddd_db_Url, $db_ddd_db_User, $db_ddd_db_Pass, $db_ddd_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_ddd_db_Url.";dbname=".$db_ddd_db_DbName, $db_ddd_db_User, $db_ddd_db_Pass);
